...
class Ui_userNotFoundForm(object):
    def setupUi(self, userNotFoundForm):
        ...
        userNotFoundForm.resize(240, 150)
        ...
        userNotFoundForm.setPalette(palette)
        self.userNotFoundButton = QtWidgets.QPushButton(userNotFoundForm)
        self.userNotFoundButton.setGeometry(QtCore.QRect(75, 90, 93, 28))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, brush)
        self.userNotFoundButton.setPalette(palette)
        self.userNotFoundButton.setObjectName("userNotFoundButton")
        self.userNotFoundLabel = QtWidgets.QLabel(userNotFoundForm)
        self.userNotFoundLabel.setGeometry(QtCore.QRect(50, 40, 151, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.userNotFoundLabel.setFont(font)
        self.userNotFoundLabel.setObjectName("userNotFoundLabel")

        self.retranslateUi(userNotFoundForm)
        QtCore.QMetaObject.connectSlotsByName(userNotFoundForm)
